 ...
 */
    ...
    function registerAddress2(address candidateDir, string memory name_) internal {
        require(
            listaCandidatos.length <= Plazas,
            "Maximo de candidatos alcanzado"
        );
    ...
    */
     ...
     */
    function calculate_init_score() internal returns (address)
    {
    ...
    function calculate_score_it() internal returns (address)
    {
